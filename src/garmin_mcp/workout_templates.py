...
WORKOUT_STRUCTURE_REFERENCE = {
    ...
    "targetType_values": {
        ...
        "2": {"workoutTargetTypeKey": "power.zone", "description": "Cycling power zone 1-7 (use zoneNumber; based on FTP %). Do NOT use for explicit watt targets."},
        ...
        "9": {"workoutTargetTypeKey": "power.lap", "description": "Cycling explicit watt target or range (use targetValueOne=low_watts, targetValueTwo=high_watts). Use this instead of power.zone when targeting specific watts, NOT zone numbers."}
    },
    "sportType_values": {
